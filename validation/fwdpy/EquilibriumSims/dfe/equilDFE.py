...
def runsim(args):
    ...
    sel_regions = [
        fwdpy11.ConstantS(
            beg=0, end=L, weight=p1, s=s1 * scaling, h=1
        ),
        fwdpy11.ConstantS(
            beg=0, end=L, weight=p2, s=s2 * scaling, h=1
        )
    ]
